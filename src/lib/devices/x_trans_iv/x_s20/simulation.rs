...
use crate::{
    ...
    ptp::{
        ...
        hex::{
            ...
            FujiMonochromaticColorShift, FujiShadowTone, FujiSharpness, FujiWhiteBalance,
...
impl fmt::Display for XS20Simulation {
...
impl Simulation for XS20Simulation {
